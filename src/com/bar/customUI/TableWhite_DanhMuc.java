...
public class TableWhite_DanhMuc extends JTable {

    private TableDarkHeader header;
    private TableDarkCell cell;
    

    public TableWhite_DanhMuc() {
    ...
    public void fixTable(JScrollPane scroll) {
        scroll.setVerticalScrollBar(new ScrollBarCustom_Table());
        JPanel panel = new JPanel();
        panel.setBackground(new Color(30, 30, 30));
        scroll.setCorner(JScrollPane.UPPER_RIGHT_CORNER, panel);
        scroll.getViewport().setBackground(new Color(30, 30, 30));
        scroll.setBorder(BorderFactory.createLineBorder(new Color(255, 255, 255), 1));
    }
    ...
    private class TableDarkCell extends DefaultTableCellRenderer {
        ...
        public Component getTableCellRendererComponent(JTable jtable, Object o, boolean bln, boolean bln1, int row, int column) {
            ...
            if (isCellSelected(row, column)) {
                if (row % 2 == 0) {
                    com.setBackground(new Color(125, 229, 237));
                } else {
                    com.setBackground(new Color(129, 198, 232));
                }
            } else {
                if (row % 2 == 0) {
                    com.setBackground(new Color(255, 255, 255));
                } else {
                    com.setBackground(new Color(243, 246, 253));
                }
            }
            com.setForeground(new Color(0, 0, 0));
